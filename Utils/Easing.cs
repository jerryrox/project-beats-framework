...
namespace PBFramework.Utils
{
	...
	public static class Easing {
		...
		/// </summary>
		private static Dictionary<EaseType, EaseHandler> Handlers;
        ...
        /// <summary>
        /// Returns the ease handler delegate which corresponds to the specified ease type.
        /// </summary>
        public static EaseHandler GetHandler(EaseType type) => Handlers[type];

        /// <summary>
        /// Returns an eased value for specified ease type.
        /// </summary>
        public static float Ease(float t, float b, float c, float d, EaseType type = EaseType.Linear)
        {
            return Handlers[type].Invoke(t, b, c, d);
        }
